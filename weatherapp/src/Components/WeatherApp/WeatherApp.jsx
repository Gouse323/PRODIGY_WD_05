...
const WeatherApp = () => {
  let api_key="83f75e65d628ed57eaa78db4e588b2b7";
  ...
  const search = async () =>{
    ...
    const tempareture=document.getElementsByClassName("weather-temp");
    const location=document.getElementsByClassName("weather-location");

    humidity[0].innerHTML=data.main.humidity+"%";
    wind[0].innerHTML=data.wind.speed+"Km/h";
    tempareture[0].innerHTML=data.main.temp+"°C";
    ...
    else if(data.weather[0].icon==='14d'||data.weather[0].icon==='14n')setWicon(snow_icon);
  ...
  return (
    <div className="container">
        ...
        <div className="weather-image">
            ...
            <div className="temp"><div className="weather-temp">24°c</div></div>
            <div className="weather-location">REPALLE</div>
